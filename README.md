## Data Science
В этом репозитории собраны мои проекты из курса профессиональной подготовки "Специалист по Data Science" компании Яндекс.Практикум.
...
- **Модуль 01 / Module 01**
  - Предобработка данных / Data Processing - *Project_01_Loan_Repayment_Probability_Predictors*
  - Исследовательский анализ данных / Exploratory data analysis - *Project_02_Determination_of_the_market_value_of_real_estate*
  - Статистический анализ данных / Statistical analysis of data - *Project_03_Comparison_of_tariff_plans_(telecom)*
  - Сборный проект / Common project - *Project_04_Identifying_a_potentially_popular_product*
- **Модуль 02 / Module 02**  
  - Введение в машинное обучение / Introduction to machine learning  - *Project_05_Call_plan_recommendation_(telecom)*
  - Обучение с учителем / Supervised learning  - *Project_06_Forecasting_the_outflow_of_bank_customers*
  - Машинное обучение в бизнесе / Machine learning in business  - *Project_07_Identifying_a_Potentially_Profitable_Oil_Well*
  - Сборный проект / Common project  - *Project_08_Predict_recovery_rate_of_gold_from_ore*
- **Модуль 03 / Module 03**  
  - Численные методы (градиентный бустинг) / Numerical analysis (gradient boosting)  - *Project_09_Determination_of_the_market value_of_the_car*
  - Временные ряды / Time series  - *Project_10_Forecast_of_taxi_orders*
  - Машинное обучение для текстов / Machine learning for texts  - *Project_11_Classification_of_toxicity_Comments*
- **Модуль 04 / Module 04**  
  - Компьютерное зрение / Computer vision  - *Project_12_Computer_vision*
- **Выпускной проект / Final project**  - *Project_final_Optimization_of_energy_consumption*
